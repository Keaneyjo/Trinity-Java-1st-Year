...
public class DaysInTheMonth {
	...
	public static void main(String[] args) {
		...
		String input2 = JOptionPane.showInputDialog("Enter month (1-" + NUMBER_OF_MONTHS + "):");
		...
		if ((year > 0) && (month >= 1) && (month <= NUMBER_OF_MONTHS))
		{
			...
			JOptionPane.showMessageDialog(null, "There are " + daysInMonth + " days in " + monthString + " in " + year + ".");
		}
		else
		{
			JOptionPane.showMessageDialog(null, "Invalid month / year.",
